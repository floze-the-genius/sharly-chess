...
| `women_title`   | `TEXT`    | NOT NULL DEFAULT ''                        | The player's chess women title                                   |
...
| Field           | Type      | Constraint                                 | Description                                                      |
|-----------------|-----------|--------------------------------------------|------------------------------------------------------------------|
| `id`            | `INTEGER` | NOT NULL<br/>PRIMARY KEY<br/>AUTOINCREMENT | The ID                                                           |
| `tournament_id` | `INTEGER` | NOT NULL                                   | The player's tournament                                          |
| `round`         | `INTEGER` | NOT NULL                                   | The round the adjustment applies to                              |
| `delta`         | `REAL`    | NOT NULL DEFAULT 0                         | The points value of the adjustment                               |
| `reason`        | `TEXT`    |                                            | The reason of the adjustment                                     |
| `mail`          | `TEXT`    |                                            | The player's email address                                       |
| `phone`         | `TEXT`    |                                            | The player's phone number                                        |
| `comment`       | `TEXT`    |                                            | Comments about the player                                        |
| `owed`          | `FLOAT`   | NOT NULL                                   | Amount of money owed by the player                               |
